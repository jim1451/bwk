...
public class SweetDialog extends Dialog implements View.OnClickListener {
    ...
    private OnSweetClick mCancelClickListener;
    private OnSweetClick mConfirmClickListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCancelClickListener == null) {
            mCancelClickListener = new OnSweetClick() {
                @Override
        ...
        if (mConfirmClickListener == null) {
            mConfirmClickListener = new OnSweetClick() {
                @Override
                public void onClick(SweetDialog sweetDialog) {
                    sweetDialog.dismiss();
                }
    ...
    public SweetDialog setCancelText(String text, OnSweetClick onCancelListener) {
        mCancelClickListener = onCancelListener;
        mCancelText = text;
        if (mCancelButton != null && mCancelText != null) {
            showCancelButton(true);
            mCancelButton.setText(mCancelText);
    ...
    public SweetDialog setConfirmText(String text, OnSweetClick onConfimListener) {
        mConfirmClickListener = onConfimListener;
        mConfirmText = text;
        if (mConfirmButton != null && mConfirmText != null) {
            mConfirmButton.setText(mConfirmText);
        }
