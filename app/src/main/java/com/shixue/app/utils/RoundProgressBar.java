...
//		TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.RoundProgressBar);
        ...
        //��ȡ�Զ������Ժ�Ĭ��ֵ
        roundColor = mTypedArray.getColor(R.styleable.RoundProgressBar2_roundColor, Color.WHITE);
        roundProgressColor = mTypedArray.getColor(R.styleable.RoundProgressBar2_roundProgressColor, Color.WHITE);
        textColor = mTypedArray.getColor(R.styleable.RoundProgressBar2_textColor, Color.WHITE);
        textSize = mTypedArray.getDimension(R.styleable.RoundProgressBar2_textSize, 40);
        roundWidth = mTypedArray.getDimension(R.styleable.RoundProgressBar2_roundWidth, 5);
        max = mTypedArray.getInteger(R.styleable.RoundProgressBar2_max, 100);
        textIsDisplayable = mTypedArray.getBoolean(R.styleable.RoundProgressBar2_textIsDisplayable, true);
        style = mTypedArray.getInt(R.styleable.RoundProgressBar2_style, 0);
