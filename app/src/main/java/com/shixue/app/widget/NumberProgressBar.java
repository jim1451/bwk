...
public class NumberProgressBar extends ProgressBar {
    ...
    private static final int DEFAULT_TEXT_COLOR =  Color.parseColor("#3ac9af");
    private static final int DEFAULT_COLOR_UNREACHED_COLOR = Color.parseColor("#767676");
    ...
    private void obtainStyledAttributes(AttributeSet attrs) {
        ...
        int textVisible = attributes
                .getInt(R.styleable.NumberProgressBar_progress_text_visibility,
                        VISIBLE);
